...
"""Initial count of columns = 16

We dropped instant , dteday, casual and registered.

Remaining column count = 12

### Datatype check - Sanity checks
"""
...
# Makes all the values between 0-1
...
"""## Building Model using statsmodel lib
...
# Since we no longer have any column with VIF higher than 2,
X_train_rfe.columns

"""### Model3
Post dropping windspeed
"""
...
"""### Model4
Post dropping winter due to high p value i.e. low significance
"""
...
#col 4 has a high p value p-val>0.05
X_train_rfe=X_train_rfe.drop([4],axis=1)

"""Model5
Post dropping col4 due to high p vlaue.
"""
...
"""### Model6 
Post adding column for Saturday
"""
...
"""### Model9 
After adding a working day to predictor variables
"""
...
"""Adding month 7 and 10 have improved our model, so we keep them"""
...
*   Demands increases in the month of 3, 5, 6, 8 ,9, 7 , 10 and yr (positive coeff)
